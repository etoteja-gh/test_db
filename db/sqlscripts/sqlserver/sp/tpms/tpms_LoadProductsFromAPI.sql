...
CREATE PROCEDURE [dbo].[tpms_LoadProductsFromAPI] AS

/*********************************
 * sp_TPMS_LoadProductsFromAPI   
 * Load Products table from APIProducts
 * B. Sullivan   7/21/04
 *********************************/
...
VALUES (@BatchOID, @BatchStart, 'LoadProductsFromAPI', GetDate(), 'Running')
